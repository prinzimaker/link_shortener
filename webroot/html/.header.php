...
?><html>
    ...
    <body>
        <div>
            ...
            <tr><td align="left"><nav class="nav-row"><a class="nav-item" href="/">Home</a>&nbsp;|&nbsp;<a class="nav-item" href="https://github.com/prinzimaker/link_shortener" target='_blank'>About</a>&nbsp;|&nbsp;<a class="nav-item" href="/login">Login</a></nav></td><td>&nbsp;</td></tr>
        </table>
        </div>
